...
class _AddMeasurementScreenState extends State<AddMeasurementScreen>
  ...
  Future<void> _saveMeasurement() async {
    ...
    try {
      final result = await MeasurementService.addMeasurements(
        customerId: widget.customer.id, tailorId: tailorId,
      ...
      if (result == null) {
        await CustomerService.updateMeasurementStatus(
            customerId: widget.customer.id, hasMeasurements: true);
        if (mounted) {
          setState(() => _isSaving = false);
          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
            content: const Row(children: [
              ...
              SizedBox(width: 10),
              Text('Measurement saved successfully!', style: TextStyle(fontWeight: FontWeight.w600)),
            ]),
        ...
        child: _isSaving
            ...
            : const Row(
                ...
                children: [
                  ...
                  SizedBox(width: 8),
                  Text('Save measurement', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, letterSpacing: 0.1)),
                ],
              ),
      ),
    );
